...
<html lang="en">
  <head>
    ...
    <!-- Favicons -->
    <link rel="apple-touch-icon" href="{{asset('public/image/apple-touch-icon.png')}}">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="navbar-left">
          ...
          <a class="navbar-brand" href="{{route('welcome')}}">
            <img class="logo-dark" src="{{asset('public/image/logo-dark.png')}}" alt="logo">
            <img class="logo-light" src="{{asset('public/image/logo-light.png')}}" alt="logo">
          </a>
        </div>
   ...
   @yield('header')
      ...
      <div class="container">
        <div class="row gap-y align-items-center">
          ...
          <div class="col-6 col-lg-3">
            <a href="/"><img src="{{asset('public/image/logo-dark.png')}}" alt="logo"></a>
          </div>
    ...
    <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5f01ef196e7b24c4"></script>
